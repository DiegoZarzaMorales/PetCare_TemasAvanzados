...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-mb^z49#7d*vs!9s_9t@nj@n%oynwe=hzbzp5^l6xm1skrvdstr'
)

# Debug is True by default for local development. Set DEBUG=False env var in production.
